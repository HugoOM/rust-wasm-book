...
// Abstraction over log_1 that provide a println-like API
macro_rules! log {
    ( $( $t:tt )* ) => {
        unsafe { log_1(format!( $( $t )* ).into()); }
    }
}
...
impl Universe {
    ...
    #[allow(unused_unsafe)] //? Invalid warning ?
    pub fn new() -> Universe {
        // panic!("Synthetic Issue");
